...
// import { setSelectedKeys, resetBreadcrumb, setOpenKeys } from '../actions/sysActions';
...
//         <Icon
//           className={`custom-tabs-left ${this.state.leftBtn ? '' : 'notActive'}`}
//           type="left"
//           onClick={this.moveLeft.bind(this)} />
//         <Icon
//           className={`custom-tabs-right ${this.state.rightBtn ? '' : 'notActive'}`}
//           type="right"
//           onClick={this.moveRight.bind(this)} />

//         <div
//           className="custom-tabs-wrap"
//           ref={this.fixedNode}>
//           <div
...
//     history.push(path);
//     this.props.dispatch(setSelectedKeys([path]));
...
//       }
//       this.props.dispatch(setSelectedKeys([newPath]));
